...
Standalone OpenWrt package files for ordered SMS forwarding through the MT5700M native helpers to a Feishu bot. Feishu cards include live CPE/5G status, and the package also provides managed scheduled SMS and a LuCI WebUI.
